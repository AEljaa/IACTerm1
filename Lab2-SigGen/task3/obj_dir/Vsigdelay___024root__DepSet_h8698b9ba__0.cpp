...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    __Vdly__sigdelay__DOT__address = 0;
    SData/*8:0*/ __Vdlyvdim0__sigdelay__DOT__sigRam__DOT__ram_array__v0;
    __Vdlyvdim0__sigdelay__DOT__sigRam__DOT__ram_array__v0 = 0;
    CData/*7:0*/ __Vdlyvval__sigdelay__DOT__sigRam__DOT__ram_array__v0;
    __Vdlyvval__sigdelay__DOT__sigRam__DOT__ram_array__v0 = 0;
    CData/*0:0*/ __Vdlyvset__sigdelay__DOT__sigRam__DOT__ram_array__v0;
    __Vdlyvset__sigdelay__DOT__sigRam__DOT__ram_array__v0 = 0;
    // Body
    ...
    __Vdly__sigdelay__DOT__address = ((IData)(vlSelf->rst)
                                       ? 0U : (0x1ffU 
                                               & ((IData)(vlSelf->sigdelay__DOT__address) 
                                                  + (IData)(vlSelf->sigdelay__DOT__addrCounter__DOT__incr))));
    if (vlSelf->wr) {
