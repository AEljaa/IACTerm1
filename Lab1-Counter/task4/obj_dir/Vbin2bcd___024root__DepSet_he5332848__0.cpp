...
VL_INLINE_OPT void Vbin2bcd___024root___nba_sequent__TOP__0(Vbin2bcd___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbin2bcd__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbin2bcd___024root___nba_sequent__TOP__0\n"); );
    // Body
...
void Vbin2bcd___024root___eval_nba(Vbin2bcd___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vbin2bcd___024root___nba_sequent__TOP__0(vlSelf);
    }
}
