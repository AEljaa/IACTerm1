...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+10,"C_WIDTH", false,-1, 31,0);
    tracep->declBit(c+5,"clk", false,-1);
    tracep->declBit(c+6,"rst", false,-1);
    tracep->declBus(c+7,"N", false,-1, 15,0);
    tracep->declBus(c+8,"data_out", false,-1, 7,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+2,(vlSelf->top__DOT__clocktick__DOT__count),16);
    bufp->fullIData(oldp+3,(vlSelf->top__DOT__f1_lights__DOT__current_state),32);
    bufp->fullIData(oldp+4,(vlSelf->top__DOT__f1_lights__DOT__next_state),32);
